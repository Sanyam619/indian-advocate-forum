...
export default function HimachalPradeshHighCourt({ news }: Props) {
  return (
    <Layout>
      <Head>
...
export const getServerSideProps: GetServerSideProps = async () => {
  try {
    const newsData = await prisma.news.findMany({
      where: { courtName: 'Himachal Pradesh High Court' },
    ...
    console.error('Error fetching Himachal Pradesh High Court news:', error);
    return { props: { news: [] } };
  }
};
