...
export default function UttarakhandHighCourt({ news }: Props) {
  return (
    <Layout>
      <Head>
...
export const getServerSideProps: GetServerSideProps = async () => {
  ...
  try {
    const newsData = await prisma.news.findMany({
      where: { courtName: 'Uttarakhand High Court' },
    ...
    console.error('Error fetching Uttarakhand High Court news:', error);
    return { props: { news: [] } };
  }
};
