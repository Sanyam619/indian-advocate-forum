...
export default function AndhraPradeshHighCourt({ news }: Props) {
  return (
    <Layout>
      <Head>
...
export const getServerSideProps: GetServerSideProps = async () => {
  ...
  try {
    const newsData = await prisma.news.findMany({
      where: { courtName: 'Andhra Pradesh High Court' },
    ...
    console.error('Error fetching Andhra Pradesh High Court news:', error);
    return { props: { news: [] } };
  }
};
