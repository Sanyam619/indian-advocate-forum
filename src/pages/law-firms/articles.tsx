...
interface LawFirmArticlesProps {
  isPremium: boolean;
  isAuthenticated: boolean;
}

const LawFirmArticles: React.FC<LawFirmArticlesProps> = ({ isPremium, isAuthenticated }) => {
  ...
  if (!isPremium) {
    return (
      <>
        <Head>
          <title>Law Firm Articles - Premium Content | Indian Advocate Forum</title>
        </Head>
        <Layout>
            ...
            <div className="max-w-2xl mx-auto px-4">
              <div className="bg-white rounded-2xl shadow-2xl p-8 md:p-12 border-2 border-purple-200">
                <div className="text-center">
                  ...
                  <p className="text-lg text-gray-600 mb-8">Upgrade to premium to access Law Firm Articles and expert legal insights</p>
